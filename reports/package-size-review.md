...
| `@apexmed/devtools`    |        19,940 |        21,000 |         74,536 |          80,000 |
| `@apexmed/docx`        |       179,786 |       200,000 |        903,911 |       1,000,000 |
| `@apexmed/engine`      |        25,446 |        28,000 |         98,603 |         110,000 |
| `@apexmed/fonts`       |     5,526,372 |     5,800,000 |     11,218,116 |      11,500,000 |
| `@apexmed/forms`       |        65,101 |        75,000 |        300,485 |         340,000 |
| `@apexmed/images`      |        51,455 |        58,000 |        214,064 |         240,000 |
...
| **Public package set** | **6,108,723** | **6,700,000** | **13,833,313** |  **15,500,000** |

The fonts tarball accounts for 11,063,438 asset bytes. Its generated catalog inventory contains the six-family static TrueType catalog across Bricolage Grotesque, Geist, Geist Mono, Instrument Sans, Instrument Serif, and Inter. The tarball gate separately requires catalog provenance plus each family's OFL file.
