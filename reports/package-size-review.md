...
| ------------------------- | ------------: | ------------: | -------------: | --------------: |
| `apex-docx-pdf`           |         7,002 |         8,000 |         18,113 |          22,000 |
| `@apex-docx-pdf/browser`  |        16,444 |        18,000 |         61,239 |          70,000 |
| `@apex-docx-pdf/core`     |        15,972 |        17,000 |         56,757 |          65,000 |
| `@apex-docx-pdf/devtools` |        19,021 |        21,000 |         71,077 |          80,000 |
| `@apex-docx-pdf/docx`     |       125,575 |       140,000 |        645,001 |         720,000 |
| `@apex-docx-pdf/engine`   |        23,680 |        26,000 |         91,378 |         105,000 |
| `@apex-docx-pdf/fonts`    |     2,067,912 |     2,300,000 |      4,220,499 |       4,700,000 |
| `@apex-docx-pdf/images`   |        32,189 |        38,000 |        126,390 |         160,000 |
| `@apex-docx-pdf/layout`   |        73,341 |        82,000 |        344,676 |         390,000 |
| `@apex-docx-pdf/pdf`      |        32,829 |        40,000 |        131,952 |         165,000 |
| `@apex-docx-pdf/template` |        50,036 |        52,000 |        231,458 |         260,000 |
| **Public package set**    | **2,464,001** | **2,700,000** |  **5,998,540** |   **6,600,000** |
...
`bun run packages:consumer-smoke` additionally installs the tarballs into clean temporary Bun projects. The production umbrella tree measured 17,550,588 bytes across 1,012 files; the all-package declaration/import tree measured 43,863,281 bytes across 1,216 files including React and TypeScript test tooling. The exact method and claim boundaries are recorded in `packed-consumer-review.md`.
