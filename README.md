...
The local-only reference playground is deployed at [pdf-docx.apexmed.dev](https://pdf-docx.apexmed.dev). That hosted browser surface is verified; it is not a persistent SaaS or production-identity claim.
