...
describe("self-hosted fonts", () => {
  ...
  test("apps/web public/fonts serves the same self-hosted files", () => {
    ...
    expect(existsSync(join(webFonts, "inter-500.ttf"))).toBe(true)
    expect(existsSync(join(webFonts, "inter-600.ttf"))).toBe(true)
    expect(existsSync(join(webFonts, "inter-700.woff2"))).toBe(true)
    expect(existsSync(join(webFonts, "inter-700.ttf"))).toBe(true)
    expect(existsSync(join(assetsDir, "inter-500.ttf"))).toBe(true)
    expect(existsSync(join(assetsDir, "inter-600.ttf"))).toBe(true)
  })
})
