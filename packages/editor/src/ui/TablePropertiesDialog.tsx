...
export function TablePropertiesDialog({
  ...
  return (
    ...
    >
      ...
      <div className="apex-table-options__body">
        <OptionsSection title="Table">
          <div className="grid gap-2">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm">
                <RadioGroupItem value="right" aria-label="Align table right" />
                Right
              </div>
            </RadioGroup>
          </div>
        ...
        <OptionsSection title="Cell">
          ...
          <div className="grid gap-1.5 text-sm">
            ...
            >
              <SelectTrigger id={`${fieldId}-vertical-align`} className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectGroup>
        ...
        <OptionsSection title="Borders">
          <div className="grid grid-cols-2 gap-3">
            <div className="grid gap-1.5 text-sm">
              ...
              >
                <SelectTrigger id={`${fieldId}-border-side`} className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectGroup>
      ...
      <footer className="apex-table-options__footer">
        <Button
          type="button"
          variant="outline"
          onClick={() => onOpenChange(false)}
