    ...
    <div className="flex items-center text-sm whitespace-nowrap text-primary">
      ...
      {isEditing ? (
        <Input
          ...
          pattern="[0-9]*"
          value={draftPage}
          className="mx-1 h-8 w-14 min-w-14 rounded-md px-1 text-center text-sm [&_[data-slot=input]]:text-center"
          ...
          {showRotateControls ? (
            <>
              ...
              <Separator
                ...
                className="mx-1 hidden h-4 w-px self-center sm:block"
              />
            </>
          ) : null}
